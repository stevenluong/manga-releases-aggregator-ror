...
class ChaptersControllerTest < ActionController::TestCase
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post :create, chapter: { date: @chapter.date, link: @chapter.link, manga_id: @chapter.manga_id, nb: @chapter.nb }
    end
  ...
  test "should update chapter" do
    put :update, id: @chapter, chapter: { date: @chapter.date, link: @chapter.link, manga_id: @chapter.manga_id, nb: @chapter.nb }
    assert_redirected_to chapter_path(assigns(:chapter))
  end
